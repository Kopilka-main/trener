      ...
      <div className="flex-1 overflow-y-auto px-4 pb-6 space-y-4">
        ...
        <Section title="Личное">
          <div className="overflow-hidden rounded-2xl">
            ...
            <RowInput label="Вес" suffix="кг" inputMode="decimal" value={form.weightKg?.toString() ?? ''} onChange={(v) => setField('weightKg', v ? Number(v) : null)} />
            <RowInput label="ID клиента" placeholder="код клиента" value={form.accountId ?? ''} onChange={(v) => setField('accountId', v || null)} last />
          </div>
        </Section>
